...
<form method="get" action="no_rekening.php">
<div class="transfer">
<div class="radio">
...
$id=$_GET['id'];
if($id!=''){
$tampil="select * from booking_kereta INNER JOIN (kereta INNER JOIN perjalanan_ker USING(no_kereta)) USING(id_kereta) where id_booking = '$id'";
...
$balita = $dataTampil['jumlah_p_b'] * $dataTampil['ongkos_balita'];
	...
	$tampil="select * from booking_kereta INNER JOIN (kereta INNER JOIN perjalanan_ker USING(no_kereta)) USING(id_kereta) where email = '$_SESSION[username1]' order by id_booking desc";
$qrytampil=mysql_query($tampil);
$dataTampil=mysql_fetch_array($qrytampil);
$dewasa = $dataTampil['jumlah_p_d'] * $dataTampil['ongkos_dewasa'];
$balita = $dataTampil['jumlah_p_b'] * $dataTampil['ongkos_balita'];
...
<tr>
<td><?php echo $dataTampil['nm_kereta'];?><br><br><p> </p></td>
<td class="transfer4"><?php echo $dataTampil['st_berangkat'];?> <?php echo $dataTampil['st_tiba'];?><br><br><p> </p></td>
</tr>
<tr>
...
<div class="batas"></div>
<input type="hidden" name="id_booking" value="<?php echo $dataTampil['id_booking']; ?>">
...
$id=$_GET['id'];
if($id !=''){
$tampil2="select * from list_booking where id_booking = '$id'";
$qrytampil2=mysql_query($tampil2);
}
else{
	$tampil2="select * from list_booking where id_booking = '$dataTampil[id_booking]'";
$qrytampil2=mysql_query($tampil2);
}
?>
<div class="col-md-3 transfer7" style="margin-left:5%">
<h4 class="transfer2">Detail Booking</h4>
 Booking Id :<?php echo $dataTampil['id_booking'];?><br>
 <?php echo $dataTampil['tgl_pergi'];?><br>
 <?php echo $dataTampil['st_berangkat'];?>--><?php echo $dataTampil['st_tiba'];?>
