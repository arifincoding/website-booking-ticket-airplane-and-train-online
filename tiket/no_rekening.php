...
<div class="batas"></div>
<a href="konfirmasi_pesan_tiket_kereta.php?id=<?php echo $dataTampil['id_booking'];?>" style="margin-top:30px;float:right;margin-right:30px;" class="btn btn-md btn-primary">Saya Sudah Bayar</a><div class="batas"></div><br><br>
<?php
}
