...
<h5 class="tambah3">Tambah Data Pesawat</h5>
<br>
<form action="aksi_tambah_pesawat.php" method="post" enctype="multipart/form-data">
<div class="form-group col-md-3">
<label>Nama Pesawat</label>
<input type="text" name="nm_pesawat" class="form-control" placeholder="nama pesawat">
</div>
<div class="form-group col-md-3">
<label>No Pesawat</label>
<input type="text" name="no_pesawat" class="form-control" placeholder="nomor pesawat">
</div>
<div class="form-group col-md-3">
<label>Kelas</label>
