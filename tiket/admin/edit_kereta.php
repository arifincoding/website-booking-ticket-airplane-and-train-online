...
$id=$_GET['id'];
$sqlTampil="select * from kereta Where id_kereta = '$id'";  
...
<h5 class="tambah3">Edit Data Kereta</h5>
<br>
<form action="aksi_edit_kereta.php" method="post">
<div class="form-group col-md-3">
<label>Nama Kereta</label>
<input type="text" name="nm_kereta" class="form-control" placeholder="nama kereta" value="<?php echo $dataTampil['nm_kereta']; ?>">
</div>
<div class="form-group col-md-3">
<label>No Kereta</label>
<input type="text" name="no_kereta" class="form-control" placeholder="nomor kereta" value="<?php echo $dataTampil['no_kereta']; ?>">
</div>
<div class="form-group col-md-3">
<label>Kelas</label>
...
<input type="text" class="form-control" name="subkelas" placeholder="subkelas" value="<?php echo $dataTampil['subkelas']; ?>">
</div>
<div class="form-group col-md-3">
...
<input type="hidden" class="form-control" name="id_kereta" placeholder="id_kereta" value="<?php echo $dataTampil['id_kereta']; ?>">
</div>
