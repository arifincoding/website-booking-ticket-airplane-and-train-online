...
<div class="navbar-default col-md-2 side" role="navigation">
  ...
  $result = mysql_query("SELECT * FROM booking_pesawat");
  $total = mysql_num_rows($result);
  $pages = ceil($total/$halaman); 
      $tampil="select * from booking_pesawat order by id_booking_p desc LIMIT $mulai, $halaman"; 
...
<h3 class="judul">Data Pesan Tiket Pesawat</h3>
...
<div class="container-fluid">
  ...
  <?php 
	...
	<td class="ukuran2"><?php echo $dataTampil['id_booking_p']; ?></td>
        <td class="ukuran2"><?php echo $dataTampil['id_pesawat']; ?></td>
		...
		<?php
		$tampil2="select * from list_booking_pesawat where id_booking_p='$dataTampil[id_booking_p]' && kategori='dewasa'"; 
	  ...
	  ?>
		...
		<?php
		$tampil2="select * from list_booking_pesawat where id_booking_p='$dataTampil[id_booking_p]' && kategori='balita'"; 
      $qryTampil2=mysql_query($tampil2); 
		$y = 1;	  
	  ?>
		<td class="ukuran2">
		...
		if($dataTampil['status']=='lunas'){
			?>
			<a data-toggle="tooltip" title="hapus" href="hapus_pesan_pesawat.php?id=<?php echo $dataTampil['id_booking_p']; ?>" onclick="return confirm('apakah anda yakin ingin menghapus pesan tiket pesawat id <?php echo $dataTampil['id_booking_p'];?>')"><span style="color:red;"class="glyphicon glyphicon-trash"></span></center></td>
