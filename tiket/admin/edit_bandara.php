...
$id=$_GET['id'];
$sqlTampil="select * from bandara Where id_bandara = '$id'";  
...
<h5 class="tambah3">Edit Data Bandara</h5>
<br>
<form action="aksi_edit_bandara.php" method="post">
<div class="form-group col-md-3">
<label>Kode Bandara</label>
<input type="text" name="kd_bandara" class="form-control" placeholder="kode stasiun" value="<?php echo $dataTampil['kode_bandara'];?>">
</div>
<div class="form-group col-md-3">
<label>Kota</label>
...
<input type="text" class="form-control" name="nm_bandara" placeholder="nama stasiun" value="<?php echo $dataTampil['nm_bandara'];?>">
<input type="hidden" name="id_bandara" value="<?php echo $dataTampil['id_bandara']; ?>">
</div>
