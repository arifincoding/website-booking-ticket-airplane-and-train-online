...
<h5 class="tambah3">Tambah Data Jadwal Perjalanan Kereta</h5>
<br>
<form action="aksi_tambah_jk.php" id="form1" method="post">
<?php 
...
<select class="form-control" id="id_kereta" name="id_kereta" onclick="tampilkan()" >
<?php
