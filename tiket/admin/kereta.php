...
<nav class="navbar navbar-default">
	...
	<li><a href="tambah_kereta.php"><span class="glyphicon glyphicon-file"></span></a></li>
...
<div class="navbar-default col-md-2 side" role="navigation">
  ...
  $result = mysql_query("SELECT * FROM kereta");
  $total = mysql_num_rows($result);
  $pages = ceil($total/$halaman); 
      $tampil="select * from kereta order by id_kereta desc LIMIT $mulai, $halaman"; 
  ...
  <?php 
    ...
    <thead>
      <tr>
        ...
        <td class="ukuran">Nama Kereta</td>
        <td class="ukuran">No kereta</td>
		<td class="ukuran">Kelas</td>
		<td class="ukuran">Sub Kelas</td>
	...
	<?php
     ...
     ?> 
      <tr>
        ...
        <td class="ukuran2"><?php echo $dataTampil['nm_kereta']; ?></td>
        <td class="ukuran2"><?php echo $dataTampil['no_kereta']; ?></td>
		<td class="ukuran2"><?php echo $dataTampil['kelas']; ?></td>
		<td class="ukuran2"><?php echo $dataTampil['subkelas']; ?></td>
		<td class="ukuran2"><?php echo $dataTampil['ongkos_balita']; ?></td>
		<td class="ukuran2"><?php echo $dataTampil['ongkos_dewasa']; ?></td>
		<td class="ukuran2"><center><a data-toggle="tooltip" title="edit" href="edit_kereta.php?id=<?php echo $dataTampil['id_kereta']; ?>">
		<span style="color:blue;" class="glyphicon glyphicon-edit"></span></a> | 
		<a data-toggle="tooltip" title="hapus" href="hapus_kereta.php?id=<?php echo $dataTampil['id_kereta']; ?>" onclick="return confirm('apakah anda yakin ingin menghapus kereta id <?php echo $dataTampil['id_kereta'];?>')">
	  ...
	  <?php 
		  ...
		  echo "  belum ada data <a href='tambah_kereta.php'>klik disini</a>";
	  }
	  }
	?> 
    </tbody>
