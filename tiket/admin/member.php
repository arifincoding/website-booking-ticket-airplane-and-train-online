...
<div class="navbar-default col-md-2 side" role="navigation">
  ...
  $pages = ceil($total/$halaman); 
      $tampil="select * from member order by id_member desc LIMIT $mulai, $halaman"; 
...
<div class="container-fluid">
  ...
  <?php 
    ...
    <thead>
      <tr>
        <td class="ukuran">Id Member</td>
        <td class="ukuran">Nama</td>
        <td class="ukuran">Email</td>
		<td class="ukuran">Kota</td>
		<td class="ukuran">Negara</td>
	...
	<?php
     ...
     ?> 
      <tr>
        <td class="ukuran2"><?php echo $dataTampil['id_member']; ?></td>
        <td class="ukuran2"><?php echo $dataTampil['username']; ?></td>
        <td class="ukuran2"><?php echo $dataTampil['email']; ?></td>
		<td class="ukuran2"><?php echo $dataTampil['kota']; ?></td>
		<td class="ukuran2"><?php echo $dataTampil['negara']; ?></td>
		<td><center><a data-toggle="tooltip" title="hapus" href="hapus_member.php?id=<?php echo $dataTampil['id_member']; ?>" onclick="return confirm('apakah anda yakin ingin menghapus member id <?php echo $dataTampil['id_member'];?>')">
