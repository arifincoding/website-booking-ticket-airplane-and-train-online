...
<h5 class="tambah3">Tambah Data Bandara</h5>
<br>
<form action="aksi_tambah_bandara.php" method="post">
<div class="form-group col-md-3">
<label>Kode Bandara</label>
<input type="text" name="kd_bandara" class="form-control" placeholder="kode bandara">
</div>
<div class="form-group col-md-3">
<label>Kota</label>
...
<input type="text" class="form-control" name="nm_bandara" placeholder="nama bandara">
</div>
