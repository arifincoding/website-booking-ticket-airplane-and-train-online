...
<h5 class="tambah3">Tambah Data Stasiun Kereta</h5>
<br>
<form action="aksi_tambah_stasiun.php" method="post">
<div class="form-group col-md-3">
<label>Kode Stasiun</label>
<input type="text" name="kd_stasiun" class="form-control" placeholder="kode stasiun">
</div>
<div class="form-group col-md-3">
<label>Kota</label>
...
<input type="text" class="form-control" name="nm_stasiun" placeholder="nama stasiun">
</div>
