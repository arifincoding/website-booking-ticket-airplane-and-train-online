...
<div class="navbar-default col-md-2 side" role="navigation">
  ...
  $result = mysql_query("SELECT * FROM stasiun_kereta ");
  $total = mysql_num_rows($result);
  $pages = ceil($total/$halaman); 
      $tampil="select * from stasiun_kereta order by id_st_kereta desc LIMIT $mulai, $halaman"; 
...
<h3 class="judul">Data Stasiun Kereta</h3>
  ...
  <?php 
    ...
    <thead>
      <tr>
        ...
        <td class="ukuran">Nama Stasiun</td>
	...
	<?php
     ...
     ?> 
      <tr>
        <td class="ukuran2"><?php echo $dataTampil['stasiun_kode']; ?></td>
        <td class="ukuran2"><?php echo $dataTampil['kota']; ?></td>
        <td class="ukuran2"><?php echo $dataTampil['nm_stasiun']; ?></td>
		<td class="ukuran2"><center><a data-toggle="tooltip" title="edit" href="edit_stasiun.php?id=<?php echo $dataTampil['id_st_kereta']; ?>"><span style="color:blue;" class="glyphicon glyphicon-edit"></span></a> | <a data-toggle="tooltip" title="hapus" href="hapus_stasiun.php?id=<?php echo $dataTampil['id_st_kereta']; ?>" onclick="return confirm('apakah anda yakin ingin menghapus stasiun kereta id <?php echo $dataTampil['id_st_kereta'];?>')"><span style="color:red;"class="glyphicon glyphicon-trash"></span></center></td>
      </tr>
	  <?php 
	}
	  }
	  else{
		  echo "  belum ada data <a href='tambah_stasiun.php'>klik disini</a>";
	  }
	  }
	?> 
    </tbody>
