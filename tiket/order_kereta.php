...
<?php
 $id=$_GET['id'];
 if($id==''){
$tampil="select * from perjalanan_ker INNER JOIN  (kereta INNER JOIN booking_kereta USING(no_kereta)) USING(no_kereta) where email='$_SESSION[username1]' order by id_booking desc";
$qryTampil=mysql_query($tampil); 
$dataTampil=mysql_fetch_array($qryTampil);
 }
 else{
	 $tampil="select * from perjalanan_ker INNER JOIN  (kereta INNER JOIN booking_kereta USING(no_kereta)) USING(no_kereta) where id_booking='$id' order by id_booking desc";
$qryTampil=mysql_query($tampil); 
$dataTampil=mysql_fetch_array($qryTampil);
 }
$total= $dataTampil['jumlah_p_d'] * $dataTampil['ongkos_dewasa']+ $dataTampil['jumlah_p_b']*$dataTampil['ongkos_balita'];?>
 ...
 <h4 class="order2">Perjalanan Pergi / <?php echo $dataTampil['nm_kereta'];?>-<?php echo $dataTampil['kelas'];?> / <?php echo $dataTampil['tgl_pergi'];?></h4>
 <h5 class="font"><span class="glyphicon glyphicon-map-marker"></span> <?php echo $dataTampil['st_berangkat'];?> <span class="glyphicon glyphicon-chevron-right"></span> <?php echo $dataTampil['st_tiba'];?></h5> 
 ...
 <form action="aksi_order_kereta.php" method="post">
...
<div class="col-md-5">
 ...
 <input class="form-control" type="hidden" name="id_booking2" value="<?php echo $dataTampil['id_booking']; ?>">
 </div>
 ...
 <input class="form-control" type="text" name="nama_dewasa[]" required>
   ...
   <input class="form-control" type="hidden" name="jenis_booking[]" value="kereta">
   <input class="form-control" type="hidden" name="kategori[]" value="dewasa">
   <input class="form-control" type="hidden" name="id_booking[]" value="<?php echo $dataTampil['id_booking']; ?>">
 <div class="batas"></div>
 <?php
 }
