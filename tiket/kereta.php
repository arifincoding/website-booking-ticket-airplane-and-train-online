...
<input class="form-control tgpul" id="yourText" disabled type="date" name="pulang">
</div>
...
<br>
<?php
 $tampil2="select * from destinasi where kategori='kereta' order by id_destinasi desc limit 0, 4"; 
...
?>
<a href="artikel_destinasi.php?id=<?php echo $dataTampil2['id_destinasi']; ?>">
...
<img class="imgpartner" src="image/Railink.png">
<img class="imgpartner" src="image/kereta.png"/>
</center>
<br>
<div class="mengapa4">
